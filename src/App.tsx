...
export default function App() {
  ...
  const bnBio = {
    ...
    fullBio: "আমি একজন সফটওয়্যার ইঞ্জিনিয়ার এবং ওপেন সোর্স ডেভেলপার, যিনি ক্লিন ওয়েব ইন্টারফেস, মজবুত এপিআই সার্ভার এবং অত্যন্ত অপ্টিমাইজড প্ল্যাটফর্ম তৈরি করতে ভালোবাসি।"
  };
